...
SECRET_KEY = 'django-insecure-6czmcd$h&*6v^xdyjh33as%j*e7vt^37p5^fvgh_c7fej+5lu9'
...
MIDDLEWARE = [
    ...
    'library.middleware.VisitMiddleware',  # Your Custom Middleware
]
...
# Storage engine for WhiteNoise to handle CSS/JS files
